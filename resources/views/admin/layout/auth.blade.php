            ...
            <div id="sidebar" class="nav-collapse " style="font-family:BYekan !important;">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="{{route('cmorgh.index')}}">
                                تیم‌های ثبت نامی
                                </a>
                            </li>
                            <li><a class="" href="{{route('startup.index')}}">
                                استارتاپ ها
                                </a>
                            </li>
                            <li><a class="" href="{{route('masters.index')}}">
                                   منتورها
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="{{route('workshop.index')}}">
                                کارگاه ها
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="{{route('blog.index')}}">
                                پست‌ها
                            </a></li>
                            <li><a class="" href="{{route('blog.create')}}">
                                ایجاد پست جدید
                            </a></li>
                    ...
                    <li class="">
                        <a class="" href="{{route('admin_teams')}}">
                            <i class="fa fa-tasks"></i>
                            <span>
                                فعالیتهای استارتاپها
                            </span>
                        </a>
                    </li>
                    <!--<li class="sub-menu">-->
